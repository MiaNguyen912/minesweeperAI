...
def createWorldFile(
    filename: "string", rowDimension: int, colDimension: int, numMines: int
) -> None:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process command line arugments for world generation"
    )

    # Parse options																													# Help is default
    parser.add_argument(
        "numFiles", help="Number of world files to create", action="store", type=int
    )  # Number of files
    parser.add_argument(
        "filename", help="Base filename", action="store"
    )  # Base filename
    parser.add_argument("rowDimension", help="Number of rows", action="store", type=int)
    parser.add_argument(
        "colDimension", help="Number of columns", action="store", type=int
    )
